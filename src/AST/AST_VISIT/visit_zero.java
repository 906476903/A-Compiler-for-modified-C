...
public class visit_zero extends MogicBaseVisitor<Object> {
    /**
     * {@inheritDoc}
     *
    ...
    public static Set<String> Class_set = new HashSet<String>();
    public static Class_table class_table = new Class_table();
    ...
    @Override public Object visitClass_decl(MogicParser.Class_declContext ctx) {
        ...
        if(Class_set.contains(id)){
            Error_msg Err = new Error_msg();
            Err.complain("Line: "+ctx.getStart().getLine()+' '+"the Class name has been defined.");
        }
        Class_set.add(id);
        table.insert(id,id,ctx.getStart().getLine());//gong yong ming zi kong jian
        visitChildren(ctx);
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public Object visitFunc_decl(MogicParser.Func_declContext ctx) { return null; }
    /**
     * {@inheritDoc}
     *
     * <p>The default implementation returns the result of calling
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public Object visitParameter_list(MogicParser.Parameter_listContext ctx) { return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     * <p>The default implementation returns the result of calling
